...
//Example
//Makes a request to the github api to fetch user data
...
//             console.log(data);
//         } catch (error) {
//             //The inner catch will only catch erros that occur during processing
//             console.log(error);
//         }
//     })
//     //The outer catch will only catch errors that occur during request
//     .catch((error) => console.log(error));
 ...
 */
//Example
//getData is declared as an async function
async function getData() {
    //Inside the async function, use await to wait for fetch to complete
